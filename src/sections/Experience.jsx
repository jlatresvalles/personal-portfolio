const experiences = [
    {
        ...
        description: "Designed, developed, configured, and maintained workflows for statewide housing and community resource programs, as well as helped organize the Homeless Management Information System Help Desk within ServiceNow and designed an Interactive Voice Response (IVR) using Amazon Connect to automatically route callers to dedicated housing programs.",
        skills: ["SimpliGov", "ServiceNow", "Amazon Connect", "Stakeholder Collaboration", "Process Automation"],
        current: true,
    },
    {
        ...
        company: "New Jersey Department of Community Affairs",
        description: "Designed, developed, configured, and maintained workflows for statewide housing and community resource programs.",
        skills: ["SimpliGov", "Process Automation", "Stakeholder Collaboration"],
        current: true,
    },
    {
