...
const projects = [
    {
        ...
        description: "Maintained and updated a public-facing referral intake form within the Bringing Veterans Home (BVH) website, replacing a manual paper process with a digital workflow and allowing veterans experiencing homelessness (or their case managers) to submit referrals that are automatically routed to the appropriate housing provider statewide.",
        image: "/projects/bvh.png",
        tags: ["SimpliGov", "Stakeholder Collaboration"],
        link: "https://njdca-dhcr.prod.simpligov.com/prod/portal/ShowWorkFlow/AnonymousEmbed/aa79d492-5db2-4696-8752-2df622d9e464",
        github: "https://bvh.dca.nj.gov/#make-referral",
    },
    {
        title: "Amazon Connect IVR System",
        description: "Built a cloud-based IVR phone system using Amazon Connect to automatically route NJ Residents to the correct housing, utility, or lead assistance program, ultimately replacing manual call handling for agency staff and enabling automated SMS follow-ups. Currently in deployment.",
